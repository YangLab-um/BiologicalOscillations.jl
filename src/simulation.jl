...
- reltol: Relative tolerance of the solver. Default value 1e-4
- maxiters: Number of maximum iterations for the solver. Default value 1e7
- fft_multiplier: Factor by which the number of time points of the solution is multiplied to be used as the number of points in the periodogram. Default value 100
